...
sed -n 1,4p   temp/z1alllog10 > temp/z1p1log10
sed -n 5,8p  temp/z1alllog10 > temp/z1p2log10
sed -n 9,11p temp/z1alllog10 > temp/z1p3log10

paste temp/z1ndof temp/z1h1 > temp/z1all
sed -n 1,4p  temp/z1all > temp/z1p1
sed -n 5,8p  temp/z1all > temp/z1p2
sed -n 9,11p temp/z1all > temp/z1p3
